...
//#include "debug3.cpp"
     ...
     *    revolution of the sun and moon.  for launcher_earth resonance effects, the
...
// [ainv, ao, con42, cosio, cosio2, eccsq, omeosq, posq, rp, rteosq, sinio]
    ...
    )
    {
        ...
        if(satrec.operationmode == 'a')
        {
            ...
            tfrac = ts70 - ds70;
            // find greenwich myLocation at epoch
...
//#include "debug5.cpp"
            ...
            final double xnodeo, SGP4SatData satrec)
    {
        ...
        /* ----------- set all near launcher_earth variables to zero ------------ */
        satrec.isimp = 0;
        satrec.method = 'n';
        satrec.aycof = 0.0;
        satrec.con41 = 0.0;
        ...
        // condition is below the surface of te launcher_earth
//     if (rp < 1.0)
//       {
...
//       }
        ...
        // sgp4fix take out check to let satellites process until they are actually below launcher_earth surface
//       if(satrec.error == 0)
...
//#include "debug7.cpp"
     ...
     *    mu          - launcher_earth gravitational parameter
     *    radiusearthkm - radius of the launcher_earth in km
